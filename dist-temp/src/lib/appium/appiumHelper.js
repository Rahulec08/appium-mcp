...
var AppiumHelper = /** @class */ (function () {
    ...
    AppiumHelper.prototype.takeScreenshot = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var timestamp, filename, filepath, screenshot, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.driver) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, fs.mkdir(this.screenshotDir, { recursive: true })];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        screenshot = _a.sent();
                        return [4 /*yield*/, fs.writeFile(filepath, Buffer.from(screenshot, "base64"))];
                    case 4:
                        _a.sent();
                        return [2 /*return*/, filepath];
                    case 5:
                        error_5 = _a.sent();
                        throw new AppiumError("Failed to take screenshot: ".concat(error_5 instanceof Error ? error_5.message : String(error_5)), error_5 instanceof Error ? error_5 : undefined);
        ...
        return __awaiter(this, arguments, void 0, function (selector, strategy, timeoutMs) {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.safeExecute(function () { return __awaiter(_this, void 0, void 0, function () {
                        var startTime, lastError, element, _a, error_6;
                        var _this = this;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                ...
                                case 2:
                                    ...
                                    return [3 /*break*/, 11];
                                case 3: return [4 /*yield*/, this.driver.$("id=".concat(selector))];
                                case 4:
                                    element = _b.sent();
                                    return [3 /*break*/, 13];
                                case 5: return [4 /*yield*/, this.driver.$("".concat(selector))];
                                case 6:
                                    element = _b.sent();
                                    return [3 /*break*/, 13];
                                case 7: return [4 /*yield*/, this.driver.$("~".concat(selector))];
                                case 8:
                                    element = _b.sent();
                                    return [3 /*break*/, 13];
                                case 9: return [4 /*yield*/, this.driver.$("".concat(selector))];
                                case 10:
                                    element = _b.sent();
                                    return [3 /*break*/, 13];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 10];
                    case 2: return [4 /*yield*/, this.driver.$$("id=".concat(selector))];
                    case 3:
                        elements = _b.sent();
                        return [3 /*break*/, 12];
                    case 4: return [4 /*yield*/, this.driver.$$("".concat(selector))];
                    case 5:
                        elements = _b.sent();
                        return [3 /*break*/, 12];
                    case 6: return [4 /*yield*/, this.driver.$$("~".concat(selector))];
                    case 7:
                        elements = _b.sent();
                        return [3 /*break*/, 12];
                    case 8: return [4 /*yield*/, this.driver.$$("".concat(selector))];
                    case 9:
                        elements = _b.sent();
                        return [3 /*break*/, 12];
                    case 10: return [4 /*yield*/, this.driver.$$("".concat(selector))];
                    case 11:
                        elements = _b.sent();
                        _b.label = 12;
                    ...
                    case 13:
                        error_7 = _b.sent();
                        throw new AppiumError("Failed to find elements with selector ".concat(selector, ": ").concat(error_7 instanceof Error ? error_7.message : String(error_7)), error_7 instanceof Error ? error_7 : undefined);
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.safeExecute(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    console.log("Attempting to tap element with ".concat(strategy, ": ").concat(selector));
                                    _loop_1 = function (attempt) {
                                        var element, _b, clickError_1, location_1, size, centerX, centerY, actions, w3cError_1, error_8, pauseTime_1;
                                        return __generator(this, function (_c) {
                                            switch (_c.label) {
                                                case 0:
                                                    _c.trys.push([0, 25, , 28]);
                                                    element = void 0;
                                                    console.log("Attempt ".concat(attempt, "/").concat(this_1.maxRetries));
                                                    _b = strategy.toLowerCase();
                                                    switch (_b) {
                                                        case "accessibility id": return [3 /*break*/, 1];
                                                        case "id": return [3 /*break*/, 3];
                                                        case "resource id": return [3 /*break*/, 3];
                                                        case "android uiautomator": return [3 /*break*/, 5];
                                                        case "uiautomator": return [3 /*break*/, 5];
                                                        case "xpath": return [3 /*break*/, 7];
                                                    }
                                                    return [3 /*break*/, 9];
                                                case 1:
                                                    console.log("Using accessibility ID strategy: ~".concat(selector));
                                                    return [4 /*yield*/, this_1.driver.$("~".concat(selector))];
                                                case 2:
                                                    element = _c.sent();
                                                    return [3 /*break*/, 11];
                                                case 3:
                                                    console.log("Using ID strategy: id=".concat(selector));
                                                    return [4 /*yield*/, this_1.driver.$("id=".concat(selector))];
                                                case 4:
                                                    element = _c.sent();
                                                    return [3 /*break*/, 11];
                                                case 5:
                                                    console.log("Using Android UiAutomator strategy: android=".concat(selector));
                                                    return [4 /*yield*/, this_1.driver.$("android=".concat(selector))];
                                                case 6:
                                                    element = _c.sent();
                                                    return [3 /*break*/, 11];
                                                case 7:
                                                    console.log("Using XPath strategy: ".concat(selector));
                                                    return [4 /*yield*/, this_1.driver.$("".concat(selector))];
                                                case 8:
                                                    element = _c.sent();
                                                    return [3 /*break*/, 11];
                                                case 9:
                                                    console.log("Using default strategy: ".concat(selector));
                                                    return [4 /*yield*/, this_1.driver.$("".concat(selector))];
                                                case 10:
                                                    element = _c.sent();
                                                    _c.label = 11;
                                                case 11:
                                                    ...
                                                    return [4 /*yield*/, element.waitForClickable({ timeout: 5000 })];
                                                case 12:
                                                    _c.sent();
                                                    _c.label = 13;
                                                case 13:
                                                    _c.trys.push([13, 15, , 23]);
                                                ...
                                                case 14:
                                                    ...
                                                    return [3 /*break*/, 23];
                                                case 15:
                                                    clickError_1 = _c.sent();
                                                    console.log("Standard click failed: ".concat(clickError_1 instanceof Error
                                                        ? clickError_1.message
                                                        : String(clickError_1)));
                                                ...
                                                case 18:
                                                    ...
                                                    return [4 /*yield*/, this_1.driver.performActions(actions)];
                                                case 19:
                                                    _c.sent();
                                                    return [3 /*break*/, 22];
                                                case 20:
                                                    ...
                                                    return [4 /*yield*/, this_1.driver.touchAction([
                                                            {
                                                                action: "tap",
                                                                x: centerX,
                                                                y: centerY,
                                                ...
                                                case 25:
                                                    ...
                                                    console.log("Tap attempt ".concat(attempt, " failed: ").concat(lastError.message));
                                                    if (!(attempt < this_1.maxRetries)) return [3 /*break*/, 27];
                                                    pauseTime_1 = this_1.retryDelay * attempt;
                                                    console.log("Will retry in ".concat(pauseTime_1, "ms"));
                                                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, pauseTime_1); })];
                                                case 26:
                                                    _c.sent();
                                                    _c.label = 27;
                                ...
                                case 3:
                                    attempt++;
                                    return [3 /*break*/, 1];
                                case 4: throw new AppiumError("Failed to tap element with selector ".concat(selector, " using strategy ").concat(strategy, " after ").concat(this.maxRetries, " attempts: ").concat(lastError === null || lastError === void 0 ? void 0 : lastError.message), lastError);
                            }
                        });
                    }); }, "Failed to tap element with selector ".concat(selector, " using strategy ").concat(strategy))];
            });
        });
    };
    /**
    ...
    AppiumHelper.prototype.sendKeys = function (selector_1, text_1) {
        return __awaiter(this, arguments, void 0, function (selector, text, strategy) {
            var lastError, attempt, element, error_9;
            var _this = this;
            if (strategy === void 0) { strategy = "xpath"; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        error_9 = _a.sent();
                        lastError = error_9 instanceof Error ? error_9 : new Error(String(error_9));
    ...
    AppiumHelper.prototype.getPageSource = function () {
        return __awaiter(this, arguments, void 0, function (refreshFirst, suppressErrors) {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.safeExecute(function () { return __awaiter(_this, void 0, void 0, function () {
                        var size, centerX, startY, endY, error_10, errorMessage, retryError_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 8, , 14]);
                                ...
                                case 8:
                                    error_10 = _a.sent();
                                    if (!(suppressErrors && error_10 instanceof Error)) return [3 /*break*/, 13];
                                ...
                                throw new AppiumError("Failed to get page source: ".concat(error_10 instanceof Error ? error_10.message : String(error_10)), error_10 instanceof Error ? error_10 : undefined);
                                case 14: return [2 /*return*/];
                            }
                        });
        ...
        return __awaiter(this, arguments, void 0, function (startX, startY, endX, endY, duration) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_11 = _a.sent();
                        throw new AppiumError("Failed to perform swipe: ".concat(error_11 instanceof Error ? error_11.message : String(error_11)), error_11 instanceof Error ? error_11 : undefined);
    ...
    AppiumHelper.prototype.longPress = function (selector_1) {
        return __awaiter(this, arguments, void 0, function (selector, duration, strategy) {
            var element, location_2, error_12;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        error_12 = _a.sent();
                        throw new AppiumError("Failed to long press element: ".concat(error_12 instanceof Error ? error_12.message : String(error_12)), error_12 instanceof Error ? error_12 : undefined);
                    case 6: return [2 /*return*/];
                }
            });
        });
    ...
    AppiumHelper.prototype.scrollToElement = function (selector_1) {
        return __awaiter(this, arguments, void 0, function (selector, direction, strategy, maxScrolls) {
            var i, size, startX, startY, endY, endX, actions, error_13;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 9:
                        error_13 = _a.sent();
                        throw new AppiumError("Failed to scroll to element: ".concat(error_13 instanceof Error ? error_13.message : String(error_13)), error_13 instanceof Error ? error_13 : undefined);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_14 = _a.sent();
                        throw new AppiumError("Failed to get orientation: ".concat(error_14 instanceof Error ? error_14.message : String(error_14)), error_14 instanceof Error ? error_14 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_15 = _a.sent();
                        throw new AppiumError("Failed to set orientation: ".concat(error_15 instanceof Error ? error_15.message : String(error_15)), error_15 instanceof Error ? error_15 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        error_16 = _a.sent();
                        throw new AppiumError("Failed to hide keyboard: ".concat(error_16 instanceof Error ? error_16.message : String(error_16)), error_16 instanceof Error ? error_16 : undefined);
                    case 6: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_17 = _a.sent();
                        throw new AppiumError("Failed to get current package: ".concat(error_17 instanceof Error ? error_17.message : String(error_17)), error_17 instanceof Error ? error_17 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_18 = _a.sent();
                        throw new AppiumError("Failed to get current activity: ".concat(error_18 instanceof Error ? error_18.message : String(error_18)), error_18 instanceof Error ? error_18 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_19 = _a.sent();
                        throw new AppiumError("Failed to launch app: ".concat(error_19 instanceof Error ? error_19.message : String(error_19)), error_19 instanceof Error ? error_19 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_20 = _a.sent();
                        throw new AppiumError("Failed to close app: ".concat(error_20 instanceof Error ? error_20.message : String(error_20)), error_20 instanceof Error ? error_20 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        error_21 = _c.sent();
                        throw new AppiumError("Failed to reset app: ".concat(error_21 instanceof Error ? error_21.message : String(error_21)), error_21 instanceof Error ? error_21 : undefined);
                    case 6: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_22 = _a.sent();
                        throw new AppiumError("Failed to get device time: ".concat(error_22 instanceof Error ? error_22.message : String(error_22)), error_22 instanceof Error ? error_22 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_23 = _a.sent();
                        throw new AppiumError("Failed to get battery info: ".concat(error_23 instanceof Error ? error_23.message : String(error_23)), error_23 instanceof Error ? error_23 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_24 = _a.sent();
                        throw new AppiumError("Failed to lock device: ".concat(error_24 instanceof Error ? error_24.message : String(error_24)), error_24 instanceof Error ? error_24 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_25 = _a.sent();
                        throw new AppiumError("Failed to check if device is locked: ".concat(error_25 instanceof Error ? error_25.message : String(error_25)), error_25 instanceof Error ? error_25 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_26 = _a.sent();
                        throw new AppiumError("Failed to unlock device: ".concat(error_26 instanceof Error ? error_26.message : String(error_26)), error_26 instanceof Error ? error_26 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_27 = _a.sent();
                        throw new AppiumError("Failed to press key code: ".concat(error_27 instanceof Error ? error_27.message : String(error_27)), error_27 instanceof Error ? error_27 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_28 = _a.sent();
                        throw new AppiumError("Failed to open notifications: ".concat(error_28 instanceof Error ? error_28.message : String(error_28)), error_28 instanceof Error ? error_28 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_29 = _a.sent();
                        throw new AppiumError("Failed to get contexts: ".concat(error_29 instanceof Error ? error_29.message : String(error_29)), error_29 instanceof Error ? error_29 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_30 = _a.sent();
                        throw new AppiumError("Failed to switch context: ".concat(error_30 instanceof Error ? error_30.message : String(error_30)), error_30 instanceof Error ? error_30 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_31 = _a.sent();
                        throw new AppiumError("Failed to get current context: ".concat(error_31 instanceof Error ? error_31.message : String(error_31)), error_31 instanceof Error ? error_31 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_32 = _a.sent();
                        throw new AppiumError("Failed to pull file: ".concat(error_32 instanceof Error ? error_32.message : String(error_32)), error_32 instanceof Error ? error_32 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_33 = _a.sent();
                        throw new AppiumError("Failed to push file: ".concat(error_33 instanceof Error ? error_33.message : String(error_33)), error_33 instanceof Error ? error_33 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (predicateString, timeoutMs) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_34 = _a.sent();
                        throw new AppiumError("Failed to find element with iOS predicate: ".concat(predicateString), error_34 instanceof Error ? error_34 : undefined);
                    case 5: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (classChain, timeoutMs) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_35 = _a.sent();
                        throw new AppiumError("Failed to find element with iOS class chain: ".concat(classChain), error_35 instanceof Error ? error_35 : undefined);
                    case 5: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_36 = _a.sent();
                        throw new AppiumError("Failed to get iOS simulators list: ".concat(error_36 instanceof Error ? error_36.message : String(error_36)), error_36 instanceof Error ? error_36 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_37 = _a.sent();
                        throw new AppiumError("Failed to perform Touch ID: ".concat(error_37 instanceof Error ? error_37.message : String(error_37)), error_37 instanceof Error ? error_37 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_38 = _a.sent();
                        throw new AppiumError("Failed to shake device: ".concat(error_38 instanceof Error ? error_38.message : String(error_38)), error_38 instanceof Error ? error_38 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_39 = _a.sent();
                        throw new AppiumError("Failed to start screen recording: ".concat(error_39 instanceof Error ? error_39.message : String(error_39)), error_39 instanceof Error ? error_39 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_40 = _a.sent();
                        throw new AppiumError("Failed to stop screen recording: ".concat(error_40 instanceof Error ? error_40.message : String(error_40)), error_40 instanceof Error ? error_40 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (command, args) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_41 = _a.sent();
                        throw new AppiumError("Failed to execute mobile command '".concat(command, "': ").concat(error_41 instanceof Error ? error_41.message : String(error_41)), error_41 instanceof Error ? error_41 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (selector, strategy) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_42 = _a.sent();
                        throw new AppiumError("Failed to get text from element with selector ".concat(selector, ": ").concat(error_42 instanceof Error ? error_42.message : String(error_42)), error_42 instanceof Error ? error_42 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_43 = _a.sent();
                        throw new AppiumError("Failed to send keys to device: ".concat(error_43 instanceof Error ? error_43.message : String(error_43)), error_43 instanceof Error ? error_43 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        error_44 = _a.sent();
                        throw new AppiumError("Failed to send key event ".concat(keyEvent, ": ").concat(error_44 instanceof Error ? error_44.message : String(error_44)), error_44 instanceof Error ? error_44 : undefined);
        ...
        return __awaiter(this, arguments, void 0, function (selector, strategy) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_45 = _a.sent();
                        throw new AppiumError("Failed to clear element with selector ".concat(selector, ": ").concat(error_45 instanceof Error ? error_45.message : String(error_45)), error_45 instanceof Error ? error_45 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    AppiumHelper.prototype.scrollScreen = function (direction_1) {
        return __awaiter(this, arguments, void 0, function (direction, distance) {
            var size, midX, midY, startX, startY, endX, endY, error_46;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_46 = _a.sent();
                        throw new AppiumError("Failed to scroll ".concat(direction, ": ").concat(error_46 instanceof Error ? error_46.message : String(error_46)), error_46 instanceof Error ? error_46 : undefined);
                    case 5: return [2 /*return*/];
                }
            });
        });
    ...
    AppiumHelper.prototype.getElementAttributes = function (selector_1) {
        return __awaiter(this, arguments, void 0, function (selector, strategy) {
            var element, result, propertiesToGet, _i, propertiesToGet_1, prop, _a, _b, e_1, _c, _d, e_2, error_47;
            if (strategy === void 0) { strategy = "xpath"; }
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 12:
                        error_47 = _e.sent();
                        throw new AppiumError("Failed to get attributes for element with selector ".concat(selector, ": ").concat(error_47 instanceof Error ? error_47.message : String(error_47)), error_47 instanceof Error ? error_47 : undefined);
    ...
    AppiumHelper.prototype.inspectElement = function (selector_1) {
        return __awaiter(this, arguments, void 0, function (selector, strategy) {
            var attributes, element, result, _a, _b, e_3, size, location_3, e_4, error_48;
            var _c;
            if (strategy === void 0) { strategy = "xpath"; }
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 14:
                        error_48 = _d.sent();
                        throw new AppiumError("Failed to inspect element with selector ".concat(selector, ": ").concat(error_48 instanceof Error ? error_48.message : String(error_48)), error_48 instanceof Error ? error_48 : undefined);
        ...
        return __awaiter(this, arguments, void 0, function (parentSelector, parentStrategy, maxDepth) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_49 = _a.sent();
                        throw new AppiumError("Failed to get element tree: ".concat(error_49 instanceof Error ? error_49.message : String(error_49)), error_49 instanceof Error ? error_49 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_50 = _a.sent();
                        throw new AppiumError("Failed to check for text in page source: ".concat(error_50 instanceof Error ? error_50.message : String(error_50)), error_50 instanceof Error ? error_50 : undefined);
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_51 = _a.sent();
                        throw new AppiumError("Failed to find elements containing text \"".concat(text, "\": ").concat(error_51 instanceof Error ? error_51.message : String(error_51)), error_51 instanceof Error ? error_51 : undefined);
                    case 4: return [2 /*return*/];
                }
            });
        });
